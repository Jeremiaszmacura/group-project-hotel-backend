...
router.post('/:id/dish/', isLoggedIn, checkIsInRole('CLERK', 'ADMIN'), restaurantController.createDish)
...
router.put('/:restaurantId/dish/:dishId', isLoggedIn, checkIsInRole('CLERK', 'ADMIN'), restaurantController.updateDish)
router.delete('/:restaurantId/dish/:dishId', isLoggedIn, checkIsInRole('CLERK', 'ADMIN'), restaurantController.removeDish)
